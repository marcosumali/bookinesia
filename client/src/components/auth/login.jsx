            ...
            <div className="input-field">
              {
                ...
                <div>
                  <div className="col s11 No-margin No-padding">
                    <input autoComplete="off" id="password" type="password" className="Input-error validate No-margin" onChange={ this.props.handleLoginInputChanges } value={ this.props.customerPassword }/>
