      ...
      <div className="row No-margin">
        <div className="col m12 s12 Contacts-box">
          ...
          <div className="col s12 m6 offset-m3 l4 offset-l4 Contacts-info-box">
            ...
            <div className="col s12 m12">
              <div className="Contacts-info-desc-text">Do you need more information? Do you want your favourite service provider to use our services? Do you need some operational assistance?</div>
            </div>
            <div className="col s12 m12 No-padding">
              ...
              <div className="col s8 m8">
                <div className="Contacts-text"><a style={{ color: '#5499c3', textDecoration: 'underline' }} href="mailto:customercare@bookinesia.com">customercare@bookinesia.com</a></div>
              </div>
            </div>
            <div className="col s12 m12 No-padding">
              <div className="col s4 m4">
