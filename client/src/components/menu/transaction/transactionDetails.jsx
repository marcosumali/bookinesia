      ...
      <div>
        {
          ...
          :
          <div className="row No-margin No-padding Details-box animated fadeIn">
            ...
            <div className="Details-content-box">
              ...
              <div className="Details-content-box Padding-10">
                  ...
                  <div className="col s4 No-margin No-padding Container-end">
                    {
                      ...
                      <div className="Status-box-progress">
                        <div className="Status-text-progress">Confirmed</div>
                      </div>
                      :
                      <div></div>
                    }
                ...
                {/* Cancel Button */}
                <div className="Cancel-box Container-center">
