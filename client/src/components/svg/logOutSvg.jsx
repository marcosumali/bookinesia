...
export default class logOutSvg extends Component {
  render() {
    return (
      ...
      <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        width={ this.props.width } height={ this.props.height } viewBox="0 0 402.779 402.779" space="preserve">
        <g>
          <g>
            <path fill={ this.props.color } d="M55.734,217.682H271.48c9.007,0,16.328-7.326,16.328-16.317c0-9.007-7.321-16.328-16.328-16.328
            ...
            <path fill={ this.props.color } d="M348.388,55.239H164.874c-29.986,0-54.38,24.405-54.38,54.396l0.022,48.332
