...
export default class supportSvg extends Component {
  render() {
    return (
      ...
      <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 488.45 488.45" width={ this.props.width } height={ this.props.height } space="preserve">
        <g>
          <g>
            <path fill={ this.props.color } d="M402.275,331.65c-52.2-19.9-83.4-40.3-83.4-40.3l-40.2,127.2l-5.5,17.2l-18-51c41.4-57.7-3.1-60.5-10.9-60.5l0,0h-0.1
            ...
            <path fill={ this.props.color } d="M142.375,228.25c-5.2,11.1-14,24.9-28.1,31.8c-4.6,2.3-3.6,9.2,1.5,10c15.4,2.4,37.5-0.3,58.1-15.9l0.3,0.2
